...
class InvestmentsControllerTest < ActionController::TestCase
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post :create, investment: { amount: @investment.amount, basicpay_id: @investment.basicpay_id, month: @investment.month, name: @investment.name, total: @investment.total }
    end
  ...
  test "should update investment" do
    patch :update, id: @investment, investment: { amount: @investment.amount, basicpay_id: @investment.basicpay_id, month: @investment.month, name: @investment.name, total: @investment.total }
    assert_redirected_to investment_path(assigns(:investment))
  end
